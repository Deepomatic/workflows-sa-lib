...
def create_region_from_prediction(image_entry_name, preds, crop_reference_bbox=None):
    '''
    ...
    Args:
        image_entry_name (str): Name of the image entry that the predictions are related to.
